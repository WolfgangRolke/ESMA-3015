---
title: Outliers - Detection  and Treatment
...
Many of the methods discussed in this class don't work well if the dataset has **outliers**. An outlier is any observation that is in some way `r hl()$fontcolor("unusual/strange/weird")`.
