...
names(x)<-NULL
x <- sort(x)
txt1 <- hl()$fontcolor(paste0(x[1:23], collapse = "  "), "black")
txt2 <- hl()$fontcolor(" 3725789  ")
txt3 <- hl()$fontcolor(paste0(x[24:51], collapse = "  "), "black")
...
PR is at the `r hl()$fontcolor("44.2nd")` percentile.
...
at least two, maybe more substancial outliers
