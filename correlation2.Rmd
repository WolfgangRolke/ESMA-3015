...
This is Northern Ireland, observation # 11. Eliminating this observations show no more outleirs, and a linear relationship:
...
**Example** below is the data from the following experiment: on 30 consecutive days we recorded the number of sales in store. During this time an add campain wos run. Find a $90\%$ confidence interval for the correlation of Day and Sales.
