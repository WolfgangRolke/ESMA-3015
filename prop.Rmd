---
title: Inference for a Proportion (Percentage) $\pi$
...
Alternative Hypothesis: Choose `r hl()$fontcolor("one")` of the following:
...
**Example** if in a survey of 350 people 200 say that they prefer Coke over Pepsi, can Coka-Cola claim that more than half of the people prefer Coke over Pepsi? Test at the 5% level.

1. Parameter: proportion $\pi$  
2. Method: exact binomial  
3. Assumptions: None  
4. $\alpha = 0.05$  
5. $H_0: \pi = 0.5$ (half like Coke, halp Pepsi)  
6. $H_a: \pi \gt 0.5$ (more than half like Coke)  
7. $p = 0.0044$  
...
8. $p = 0.0044 < \alpha=0.05$, so we reject the null hypothesis.  
9. it appears that indeed more than half of the people prefer Coke over Pepsi.
...
**Example** In the past about $12\%$ of the students in a class received an A. After some substancial changes to the class we hope that the percentage has gone up to 20. If we test at the $5\%$ and if there are 150 students in the class, what is the power of this test?
...
6. $H_a: \pi \gt 0.12$ (percentage has gone up)
...
**Example** Same story as above: in the past about $12\%$ of the students in a class received an A. After some substancial changes to the class we hope that the percentage has gone up to 20. If we test at the $5\%$ and if there are 150 students in the class, we found that we would have a power of $81.9\%$. What sample size would we need to have a power of $95\%$?
