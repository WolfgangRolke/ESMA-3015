...
For the first couple of values of the number of rolls neded we find
...
Say a certain population is known to be described by a normal distribtuion with mean 100 and standard deviation 30. From textbooks we can find the following information:
...
We can get simulated data from a normal distribtuion with mean 100 and standard deviation 30 with
